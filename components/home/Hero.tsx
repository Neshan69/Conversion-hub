    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        >
          <Link
            href="/currency"
            className="group flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold text-lg shadow-lg hover:shadow-2xl hover:shadow-primary/25 transition-all hover:scale-[1.02] active:scale-[0.98]"
            prefetch={true}
          >
            Start Converting
