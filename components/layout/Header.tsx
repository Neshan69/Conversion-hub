...
export function Header() {
  ...
  const visibleTheme = mounted ? resolvedTheme : "light";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-14 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 hover:opacity-90 transition-opacity shrink-0 group">
            ...
            <span className="text-lg font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent hidden sm:block">Conversion Hub</span>
          </Link>

          {/* Desktop Navigation */}
          <nav className="hidden lg:flex items-center gap-1 rounded-2xl border border-border/50 bg-card/40 p-1 shadow-[0_10px_40px_rgba(15,23,42,0.08)]">
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    "hover:text-foreground hover:shadow-[0_0_24px_rgba(59,130,246,0.18)]",
                    active
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        active ? "bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold shadow-lg shadow-primary/20" : "text-muted-foreground"
                      )}
                    >
